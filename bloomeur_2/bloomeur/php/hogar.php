  ...
  <main class="tienda-container">
    ...
    <aside class="filters">
      <div>
        ...
        <div class="filter-list">
          ...
          <button onclick="window.location.href='./hogar.php'" style="font-weight: 600;">HOGAR</button>
        </div>
      </div>
    ...
    <section class="products-area">
      <div class="page-header">
        <p class="breadcrumb">Home / tienda / hogar</p>
        <h1>HOGAR</h1>
      ...
      <div class="products-grid">
        <article class="product-card">
          <img src="../img/touchandb.webp" alt="Desinfectante de toronja">
        ...
        <article class="product-card">
          <img src="../img/3bot.webp" alt="Touch & Beyond">
          <div class="product-meta">HOGAR</div>
          <div class="product-name">Esencia de limoncillo</div>
          <div class="product-footer">
        ...
        <article class="product-card">
          <img src="../img/serrum.webp" alt="Pistache">
          <div class="product-meta">HOGAR</div>
        ...
        <article class="product-card">
          <img src="../img/botazul.webp" alt="Papa">
          <div class="product-meta">HOGAR</div>
          <div class="product-name">Escencia de frutas cítricas</div>
          <div class="product-footer">
