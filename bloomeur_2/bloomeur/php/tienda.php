  ...
  <main class="tienda-container">
    ...
    <aside class="filters">
      <div>
        ...
        <div class="filter-list">
          <button onclick="window.location.href='./tienda.php'" style="font-weight: 600;">(ALL)</button>
          <button onclick="window.location.href='./alimentos.php'">ALIMENTOS</button>
    ...
    <section class="products-area">
      <div class="page-header">
        <p class="breadcrumb">Home / tienda</p>
        <h1>PRODUCTOS</h1>
      ...
      <div class="products-grid">
        <article class="product-card">
          <img src="../img/crema_aguacate.webp" alt="Desinfectante de toronja">
          <div class="product-meta">HOGAR</div>
          <div class="product-name">Crema de aguacate para manos</div>
        ...
        <article class="product-card">
          <img src="../img/jabones.webp" alt="Jabón Orris Natural">
          <div class="product-meta">HOGAR</div>
        ...
        <article class="product-card">
          ...
          <div class="product-name">Kombucha de jengible y limón</div>
          <div class="product-footer">
        ...
        <article class="product-card">
          <img src="../img/skincare.webp" alt="Kit skincare">
          <div class="product-meta">COSMETICOS</div>
          <div class="product-name">Rutina de skincare</div>
          <div class="product-footer">
        ...
        <article class="product-card">
          ...
          <div class="product-meta">ALIMENTOS</div>
          <div class="product-name">Snaks de papa</div>
          <div class="product-footer">
        ...
        <article class="product-card">
          <img src="../img/ultra.webp" alt="Suplemento ultra">
          <div class="product-meta">ALIEMENTOS</div>
          <div class="product-name">Ultra suplemento</div>
          <div class="product-footer">
